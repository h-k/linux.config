...
map <F3> :silent! exe printf("match IncSearch /\\<%s\\>/", expand('<cword>'))<CR>
...
" https://gist.github.com/048616a2e3f5d1b5a9ad
function! Refactor()
	call inputsave()
	let @z=input("What do you want to rename '" . @z . "' to? ")
	call inputrestore()
endfunction
" Locally (local to block) rename a variable (press \rf)
nmap <Leader>rf "zyiw:call Refactor()<cr>mx:silent! norm gd<cr>[{V%:s/<C-R>//<c-r>z/g<cr>`x

" TODO, NOTE etc
" http://stackoverflow.com/questions/6577579/task-tags-in-vim
" fix /usr/share/vim/vim73/syntax/c.vim for most of these words
if has("autocmd")
  " Highlight ###
  if v:version > 701
    autocmd Syntax * call matchadd('Todo',  '\W\zs\(###\)')
  endif
endif
