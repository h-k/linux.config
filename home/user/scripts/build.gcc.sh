...
EXTRA_GCC_OPTIONS="$EXTRA_GCC_OPTIONS --with-gcc-version=4.8.1"
EXTRA_GCC_OPTIONS="$EXTRA_GCC_OPTIONS --with-binutils-version=2.23.2"
EXTRA_GCC_OPTIONS="$EXTRA_GCC_OPTIONS --with-gmp-version=5.1.2"
EXTRA_GCC_OPTIONS="$EXTRA_GCC_OPTIONS --with-mpfr-version=3.1.2"
EXTRA_GCC_OPTIONS="$EXTRA_GCC_OPTIONS --with-mpc-version=1.0.1"
EXTRA_GCC_OPTIONS="$EXTRA_GCC_OPTIONS --with-gdb-version=7.6"
...
make all-gcc -j $LEVEL ; make install-gcc
